    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_earnings', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='INR', max_digits=10)),
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='operation_manifest.City')),
                ('custom_center_cluster', models.ManyToManyField(blank=True, to='center.CustomCenterCluster')),
